...
#Heading 
heading=CTkLabel(master=app,text="Directing System Management Decision Making using Forensic Analysis of Web Applicaton",font=("Arial Black",24))
...
url=CTkEntry(master=tabview.tab("ACTIVE"),placeholder_text="Enter URl to enumerate",width=900,height=40,font=("Aria Black",18))
url.pack()
